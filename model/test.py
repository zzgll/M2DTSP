...
def main():
    ...
    # Add argument
    parser.add_argument('--model_path', required=False, type=str,default="/home/best/DataDTA/MGraphDTA/filtered_davis/save/20241006_172736_davis_prot/model/epoch-95, loss-0.1296, cindex-0.9152, val_loss-0.2507, test_loss-0.2423.pt", help='model path ready to load')
    ...
    _, _, test_index = read_sets(fpath, 1, split_type='our_warmv1')
