...
def main():
    ...
    # Add argument
    parser.add_argument('--fold', required=False,default=1, help='k-th fold, from 0 to 4')
    parser.add_argument('--save_model', action='store_true',default="model_path", help='whether save model or not')
    ...
    train_index, val_index, test_index = read_sets(fpath, fold_num, split_type='our_warmv1')
    ...
    model = M2DTSP(3, 25 + 1, embedding_size=128, filter_num=32, out_dim=1).to(device)
